...
folder = '/home/dhan/Desktop/CS5820-Assignments/Assignment2'
filter_extract_beam(req_fields=req_fields,all_files_path=folder,current_dir = os.getcwd())
# visualize_beam(req_fields = req_fields,current_dir=os.getcwd())
visualize_beam(current_dir = os.getcwd(),req_fields=req_fields)